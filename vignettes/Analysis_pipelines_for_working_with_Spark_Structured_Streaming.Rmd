---
title: "Analysis pipelines for working with Spark Structured Streaming"
author: "Naren Srinivasan"
date: "8/24/2018"
output: rmarkdown::html_vignette
<!-- vignette: > -->
<!--   %\VignetteIndexEntry{Analysis pipelines for working with Spark Structured Streaming} -->
<!--   %\VignetteEngine{knitr::rmarkdown} -->
<!--   %\VignetteEncoding{UTF-8} -->
---
# Objective

* Implement a pipeline using SparkR structured streaming functionss

# Define analysis pipeline based on Structured Streaming functions using SparkR
...
pipelineObj <- readInputSpark(input = streamObj)
pipelineObj %>>% getRegistry

pipelineObj %>>% castKafkaStreamAsString %>% convertKafkaValueFromJson(schema = schema) -> pipelineObj
pipelineObj %>>% getPipeline

pipelineObj %>>% generateOutput() -> pipelineObj
pipelineObj %>>% getOuputByOrderId(2)-> streamObj
printSchema(streamObj)
