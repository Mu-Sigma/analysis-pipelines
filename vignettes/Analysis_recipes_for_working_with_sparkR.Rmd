...
ggplot(occpancyAnalysisResultDf, aes(location_type, avgOccupancy, color=location_type)) +
  geom_col()
...
ggplot(bookingChannelsAnalysisResultDf, aes(location_type, avgCallCenterBookingPct, color=location_type)) +
  geom_col()
