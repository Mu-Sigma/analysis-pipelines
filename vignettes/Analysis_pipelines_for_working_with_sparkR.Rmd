...
*Apache Spark* can be leveraged to process large volumes of distributed data that are typically impossible to process on standlone R servers. The vignette describes defining and executing *Spark*-only pipelines using the *analysisPipelines* package.
