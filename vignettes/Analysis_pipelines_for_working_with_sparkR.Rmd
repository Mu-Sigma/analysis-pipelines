...
occupancyAnalysisResultDf

# ggplot(occupancyAnalysisResultDf) + geom_col(aes(location_type, avgOccupancy, color=location_type)) 
...
ggplot2::ggplot(bookingChannelsAnalysisResultDf) + geom_col(aes(location_type, avgCallCenterBookingPct, color=location_type)) + scale_y_continuous(labels = scales::percent)
