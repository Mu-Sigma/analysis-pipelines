...
# Define pipeline 
# Do data prep
pipelineObj %>% castKafkaStreamAsString() %>% 
  convertKafkaValueFromJson(schema = consumerDataSchema, outAsIn = T) %>% convertStructToDf(outAsIn = T) %>% castDfColumns(outAsIn = T, storeOutput = T) -> pipelineObj
