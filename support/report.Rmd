...
subtitle: v`r if (!require(rjson)) {install.packages('rjson', dependencies = T, repos = "http://cloud.r-project.org/");};version=rjson::fromJSON(file = 'Description.json')['version'];version` - (`r format(Sys.Date(), "%B %d, %Y")`)
