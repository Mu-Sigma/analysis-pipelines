...
obj <- obj %>>% outlierPlot(method = "iqr",columnName = "Occupancy",cutoffValue = 0.01,priColor = "blue",optionalPlots = 1) %>>% univarCatDistPlots(uniCol = "building_type",priColor = "blue",optionalPlots = 1) %>>% bivarPlots('Occupancy','max_rooms_capacity',priColor = "blue","black") %>>% bivarPlots('hotel_id','max_rooms_capacity',priColor = "blue","black") 
